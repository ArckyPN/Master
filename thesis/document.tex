...
\lstdefinelanguage{Rust}{
  keywords={new, return, if, in, else, break, for, let, use, continue, break, mut, u8, u32, u16, u64, usize, String, const, await, async, fn, pub, dyn, struct},
...
\lstdefinelanguage{JavaScript}{
  keywords={typeof, new, true, false, catch, function, return, null, catch, switch, var, if, in, while, do, else, case, break, for, let, use, continue, break, mut, u8, String, const, await, async, fn},
